...
const NavBar = () => {
  ...
  const handleSubCategoryClick = (category, subCategory, event) => {
    console.log("Clicked Subcategory:", subCategory.id, "on", isMobile ? "Mobile" : "Desktop");
    ...
    if (isMobile) {
      ...
      if (subCategory.childsubcategories?.length) {
        console.log("Mobile - Expanding Subcategory:", subCategory.id);
        setActiveSubcategory((prev) => (prev === subCategory.id ? null : subCategory.id));
      } else {
        console.log("Mobile - Navigating to:", subCategory.name);
        navigate("/menu", { state: { category, subCategory } });
      }
    } else {
      console.log("PC/Desktop - Navigating to:", subCategory.name);
      navigate("/menu", { state: { category, subCategory } });
    }
  };

  const handleChildSubCategoryClick = (category, subCategory, childSubCategory, event) => {
    console.log("Clicked Child Subcategory:", childSubCategory.id, "on", isMobile ? "Mobile" : "Desktop");
    ...
    console.log("Navigating to:", childSubCategory.name);
    navigate("/menu", { state: { category, subCategory, childSubCategory } });
  };
